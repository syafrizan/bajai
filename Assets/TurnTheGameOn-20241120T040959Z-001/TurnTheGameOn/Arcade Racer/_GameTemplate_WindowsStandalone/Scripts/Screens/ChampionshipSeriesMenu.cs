namespace TurnTheGameOn.ArcadeRacer
{
    ...
    public class ChampionshipSeriesMenu : ScreenBase
    {
        public static ChampionshipSeriesMenu Instance = null;
        ...
        {
            SeriesManager.Instance.StartSeries(seriesData[selectedSeries], SeriesType.Championship);
        }
