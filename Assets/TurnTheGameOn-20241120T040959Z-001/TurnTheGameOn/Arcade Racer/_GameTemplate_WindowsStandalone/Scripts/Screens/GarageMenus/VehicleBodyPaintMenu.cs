namespace TurnTheGameOn.ArcadeRacer
{
    using UnityEngine;
    using TMPro;
    public class VehicleBodyPaintMenu : ScreenBase
    {
        public static VehicleBodyPaintMenu Instance = null;
        ...
        private void Start()
        {
            priceText.text = "Body Paint Color: " + price.ToString("C0");
        }
        ...
        public void Button_Back()
        {
            ...
            GameTemplate_PlayerCustomization.Instance.UpdateBodyColor();
        }

        public void SetColorHex(string hex)
        {
            GameTemplate_PlayerCustomization.Instance.SetNewBodyColor(hex);
        }
        ...
        public void ShowUnlockConfirm(string hex)
        {
            ...
            messageText.text = "Purchase paint job for " + price.ToString("C0") + "?";
        ...
        public void AcceptPurchase()
        {
            ...
            if (playerBank >= price)
            {
                ...
                GameData.SetCarBodyColorHex(PlayerVehicleManager.Instance.CurrentSelection(), selectedColorHex);
                GameTemplate_PlayerCustomization.Instance.UpdateBodyColor();
                Close();
                VehicleCustomizationMenu.Instance.Open();
            }
