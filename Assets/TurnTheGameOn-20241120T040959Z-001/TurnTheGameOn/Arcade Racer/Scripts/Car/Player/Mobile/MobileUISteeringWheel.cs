namespace TurnTheGameOn.ArcadeRacer
{
    ...
    public class MobileUISteeringWheel : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            if (!MobileInputManager.AxisExists(axisName))
            {
                ...
                m_HorizontalVirtualAxis = new MobileInputManager.VirtualAxis(axisName);
                MobileInputManager.RegisterVirtualAxis(m_HorizontalVirtualAxis);
            }
            else
            {
                m_HorizontalVirtualAxis = MobileInputManager.VirtualAxisReference(axisName);
            }
        }
        ...
        void Update()
        {
            ...
            if (wheelBeingHeld)
            {
                ...
                if (Vector2.Distance(mousePosition, wheelCenter) > 20f) // If mouse is very close to the steering wheel's center, do nothing
                {
