namespace TurnTheGameOn.ArcadeRacer
{
    ...
    [CreateAssetMenu(fileName = "AvatarDriverSettings", menuName = "TurnTheGameOn/Arcade Racer/AvatarDriverSettings")]
    public class AvatarDriverSettings : ScriptableObject
    {
        [Header("Avatar")]
